const navItems = [
  ...
  { label: "Family Night", href: "#family-night" },
...
export default function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-charcoal/10 bg-ivory/88 backdrop-blur-md">
      <nav className="section-shell flex min-h-16 flex-col items-start justify-center gap-2.5 py-3 sm:h-16 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:py-0">
        <a
          href="#top"
